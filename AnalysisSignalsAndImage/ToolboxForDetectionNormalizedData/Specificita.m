...
%% Projekt è. 10 – Statistické vyhodnocení = SPECIFICITA
...
% Skript provádí špatné pøiøazování fotografii k referenèní fotce pro dané
% oko. Urèuje poèet faleènì pozitivních a skuteènì negativních pøiøazení. 
% Poté z tìchto údajù urèí specificitu algoritmu.
...
obrazek1=['Referencni_',num2str(i),'.bmp']; 
    for j = 2:9
    obrazek2=['0',num2str(j),'_L',num2str(i+1),'.bmp']; 
    I = imread(obrazek1);
    I_2 = imread(obrazek2);
...
disp(['Poèet falešnì pozitivních ',num2str(pom_shoda), ' poèet správnì negativních ',num2str(pom_neshoda)])

%% Výpoèet senzitivity testu

specificita = pom_neshoda/(pom_shoda + pom_neshoda);
