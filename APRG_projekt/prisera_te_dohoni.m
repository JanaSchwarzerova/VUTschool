function varargout = prisera_te_dohoni(varargin)
% PRISERA_TE_DOHONI MATLAB code for prisera_te_dohoni.fig
%      PRISERA_TE_DOHONI, by itself, creates a new PRISERA_TE_DOHONI or raises the existing
%      singleton*.
%
%      H = PRISERA_TE_DOHONI returns the handle to a new PRISERA_TE_DOHONI or the handle to
%      the existing singleton*.
%
%      PRISERA_TE_DOHONI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PRISERA_TE_DOHONI.M with the given input arguments.
%
%      PRISERA_TE_DOHONI('Property','Value',...) creates a new PRISERA_TE_DOHONI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before prisera_te_dohoni_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to prisera_te_dohoni_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help prisera_te_dohoni

% Last Modified by GUIDE v2.5 23-Apr-2016 00:51:18

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @prisera_te_dohoni_OpeningFcn, ...
                   'gui_OutputFcn',  @prisera_te_dohoni_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before prisera_te_dohoni is made visible.
function prisera_te_dohoni_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to prisera_te_dohoni (see VARARGIN)

% Choose default command line output for prisera_te_dohoni
...
% UIWAIT makes prisera_te_dohoni wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = prisera_te_dohoni_OutputFcn(hObject, eventdata, handles) 
